...
/* $Id: //depot/sw/releases/Aquila_9.2.0_U10.5/apps/dhcp/dhcp-3.1.0/omapip/iscprint.c#1 $ */
...
"$Id: //depot/sw/releases/Aquila_9.2.0_U10.5/apps/dhcp/dhcp-3.1.0/omapip/iscprint.c#1 $ Copyright (c) 2004 Internet Systems Consortium, Inc.  All rights reserved.";
#endif
