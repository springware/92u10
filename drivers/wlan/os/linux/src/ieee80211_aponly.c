...
#define DESC2PA(_sc, _va)	\
		((caddr_t)((caddr_t)(_va) - (caddr_t)((_sc)->sc_txdma.dd_desc) + \
...
static struct ieee80211_txctl_cap txctl_cap[IEEE80211_TYPE4TXCTL_MAX] = {
		...
		{ 0, 0, 0, 1, 0, 1, HAL_PKT_TYPE_NORMAL, WME_AC_VO, 1, 1},		/*nodata*/
...
ieee80211_classify_aponly(struct ieee80211_node *ni, wbuf_t wbuf)
{
     ...
     * returning TOS for Maverick STA and Linux platform, where as for Windows it
     * just returns TOS.
     */
