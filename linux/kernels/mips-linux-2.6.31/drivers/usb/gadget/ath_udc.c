...
#define CUT_CLK 			(1 << 28)
#define ATH_SRAM_DEV_PTR		((struct ath_usb **)(UNCACHED_SRAM_BASE+0x1000))
#define TEMP_INT			((unsigned int *)(UNCACHED_SRAM_BASE+0x1020))
#define TEMP_INT1			((unsigned int *)(UNCACHED_SRAM_BASE+0x1040))
